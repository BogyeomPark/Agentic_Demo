...
def ask_teacher_agent(teacher_input, chat_log):
    ...
    <p><b>❗️주의: 다음 단계로 넘어가지 말고, 교사의 입력을 반드시 기다려야 합니다.</b></p>
    <hr>
    ...
    <p><b>❗️주의: 다음 단계(학과 유도)로 넘어가지 말고 교사의 입력을 기다리세요.</b></p>
    <hr>
    ...
    <p><b>❗️주의: 다음 단계로 넘어가지 마세요. 반드시 학과 확인 응답을 받아야 합니다.</b></p>
    <hr>
    ...
    <p><b>❗️주의: 전형 전략 안내는 다음 단계에서 하도록 하세요.</b></p>
    <hr>
    ...
    <p><b>💬 마지막 단계입니다. 이후에는 응답을 종료하세요.</b></p>
    <hr>
